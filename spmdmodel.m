function [f] = spmdmodel(t,y,opts,k,K,Cw,twd)
%-----------------------------------------------------------
...
VM = 2;                                         %[cm^3] volume of c18 in the empore disk - Green
VS = .5;                                       %[cm^3] volume of c18 in the empore disk - Green
